...
var useField = function useField(name, _temp) {
  ...
  var flattenedSubscription = flattenSubscription(subscription);
  React.useEffect(function () {
  ...
  // validate,
  initialValue, isEqual, validateFields, // eslint-disable-next-line react-hooks/exhaustive-deps
...
var ReactFinalForm = function ReactFinalForm(_ref) {
  ...
  var _React$useState = React.useState(function () {
    ...
    return initialState;
      ...
      state = _React$useState[0],
      setState = _React$useState[1]; // In the future, changing subscriptions on the fly should be banned. ⚠️
  ...
  }, [decorators, flattenedSubscription]); // warn about decorator changes
  // istanbul ignore next
